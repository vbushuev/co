...
use \Vsb\Vsb as Vsb;
use \Vsb\Gateway\Ariuspay\Response as Response;
use \Vsb\Gateway\Ariuspay\Exception as VsbGatewayAriuspayException;
...
class CallbackResponse extends Response{
    ...
    public function accept(){
        switch(trim($this->_params["status"])){
            case "error":
                throw new VsbGatewayAriuspayException("Transaction is declined but something went wrong, please inform your account manager.",500);
            case "declined":
                throw new VsbGatewayAriuspayException("Transaction is declined.",500);
            case "filtered":
                throw new VsbGatewayAriuspayException("Transaction is declined by fraud internal or external control systems.",500);
            case "unknown":
            case "processing":
                return false;
            case "approved":
